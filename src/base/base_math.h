...
#define degrees_from_radians_f32(v)                                            \
        (degrees_from_turns_f32(turns_from_radians_f32(v)))
#define radians_from_degrees_f32(v)                                            \
        (radians_from_turns_f32(turns_from_degrees_f32(v)))
...
#define degrees_from_radians_f64(v)                                            \
        (degrees_from_turns_f64(turns_from_radians_f64(v)))
#define radians_from_degrees_f64(v)                                            \
        (radians_from_turns_f64(turns_from_degrees_f64(v)))
...
internal Mat4x4F32 make_perspective_vulkan_4x4f32(F32 fov, F32 aspect_ratio, F32 near_z, F32 far_z);
internal Mat4x4F32 make_orthographic_4x4f32(F32 left, F32 right, F32 bottom, F32 top, F32 near_z, F32 far_z);
internal Mat4x4F32 make_orthographic_vulkan_4x4f32(F32 left, F32 right, F32 bottom, F32 top, F32 near_z, F32 far_z);
