...
d_geo3d_begin(Rng2F32 viewport, Mat4x4F32 view, Mat4x4F32 projection, Vec3F32 global_light, B32 show_grid, B32 light_disabled)
{
    ...
    R_PassParams_Geo3D *params = pass->params_geo3d;
    {
        ...
        params->light_disabled = light_disabled;
    }
    return params;
}
