...
internal Vec2F32                    d_push_viewport(Vec2F32 v) {D_StackPushImpl(Viewport, viewport, Vec2F32, v);}
...
internal Vec2F32                    d_pop_viewport(void) {D_StackPopImpl(Viewport, viewport, Vec2F32);}
...
internal Vec2F32                    d_top_viewport(void) {D_StackTopImpl(Viewport, viewport, Vec2F32);}
