...
#define IK_StrokeSizePx_Scope(v) DeferLoop(ik_push_stroke_size_px(v), ik_pop_stroke_size_px())
...
internal F32 ik_top_stroke_size_px(void) { IK_StackTopImpl(ik_state, StrokeSizePx, stroke_size_px) }
...
internal F32 ik_bottom_stroke_size_px(void) { IK_StackBottomImpl(ik_state, StrokeSizePx, stroke_size_px) }
...
internal F32 ik_push_stroke_size_px(F32 v) { IK_StackPushImpl(ik_state, StrokeSizePx, stroke_size_px, F32, v) }
...
internal F32 ik_pop_stroke_size_px(void) { IK_StackPopImpl(ik_state, StrokeSizePx, stroke_size_px) }
...
internal F32 ik_set_next_stroke_size_px(F32 v) { IK_StackSetNextImpl(ik_state, StrokeSizePx, stroke_size_px, F32, v) }
