...
typedef struct IK_StokeSizeNode IK_StokeSizeNode; struct IK_StokeSizeNode{IK_StokeSizeNode *next; F32 v;};
...
IK_StokeSizeNode stoke_size_nil_stack_top;\
...
state->stoke_size_nil_stack_top.v = 16;\
...
struct { IK_StokeSizeNode *top; F32 bottom_val; IK_StokeSizeNode *free; B32 auto_pop; } stoke_size_stack;\
...
state->stoke_size_stack.top = &state->stoke_size_nil_stack_top; state->stoke_size_stack.bottom_val = 16; state->stoke_size_stack.free = 0; state->stoke_size_stack.auto_pop = 0;\
...
if(state->stoke_size_stack.auto_pop) { ik_pop_stoke_size(); state->stoke_size_stack.auto_pop = 0; }\
...
internal F32                        ik_top_stoke_size(void);
...
internal F32                        ik_bottom_stoke_size(void);
...
internal F32                        ik_push_stoke_size(F32 v);
...
internal F32                        ik_pop_stoke_size(void);
...
internal F32                        ik_set_next_stoke_size(F32 v);
