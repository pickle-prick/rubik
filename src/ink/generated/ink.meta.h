...
typedef struct IK_StrokeSizePxNode IK_StrokeSizePxNode; struct IK_StrokeSizePxNode{IK_StrokeSizePxNode *next; F32 v;};
...
IK_StrokeSizePxNode stroke_size_px_nil_stack_top;\
...
state->stroke_size_px_nil_stack_top.v = 8;\
...
struct { IK_StrokeSizePxNode *top; F32 bottom_val; IK_StrokeSizePxNode *free; B32 auto_pop; } stroke_size_px_stack;\
...
state->stroke_size_px_stack.top = &state->stroke_size_px_nil_stack_top; state->stroke_size_px_stack.bottom_val = 8; state->stroke_size_px_stack.free = 0; state->stroke_size_px_stack.auto_pop = 0;\
...
if(state->stroke_size_px_stack.auto_pop) { ik_pop_stroke_size_px(); state->stroke_size_px_stack.auto_pop = 0; }\
...
internal F32                        ik_top_stroke_size_px(void);
...
internal F32                        ik_bottom_stroke_size_px(void);
...
internal F32                        ik_push_stroke_size_px(F32 v);
...
internal F32                        ik_pop_stroke_size_px(void);
...
internal F32                        ik_set_next_stroke_size_px(F32 v);
